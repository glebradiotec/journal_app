...
Верни ТОЛЬКО валидный JSON без пояснений, в формате:
{
  ...
  "authors": [
    {"name": "ФИО автора", "email": "email@example.com", "organization": "Название организации", "degree": "Учёная степень и/или звание"}
  ]
}
...
- Если email, организация или степень не указаны — оставь пустую строку ""
- Если у нескольких авторов одна организация — укажи её каждому
- В поле degree указывай учёную степень (канд. техн. наук, д-р физ.-мат. наук и т.п.) и/или учёное звание (доцент, профессор и т.п.), если они указаны в тексте
